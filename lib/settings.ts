  ...
  try {
    const updatedSettings = await prisma.user_settings.upsert({
      ...
      update: {
        ...
        pomodoro_work_minutes: settings.pomodoro_work_minutes ? Number(settings.pomodoro_work_minutes) : undefined,
        pomodoro_break_minutes: settings.pomodoro_break_minutes ? Number(settings.pomodoro_break_minutes) : undefined,
        pomodoro_long_break_minutes: settings.pomodoro_long_break_minutes ? Number(settings.pomodoro_long_break_minutes) : undefined,
        pomodoro_cycles: settings.pomodoro_cycles ? Number(settings.pomodoro_cycles) : undefined,
        ...
        task_notification_days: settings.task_notification_days ? Number(settings.task_notification_days) : undefined,
      ...
      create: {
        ...
        theme: settings.theme || "system",
        language: settings.language || "pt",
        pomodoro_work_minutes: settings.pomodoro_work_minutes ? Number(settings.pomodoro_work_minutes) : 25,
        pomodoro_break_minutes: settings.pomodoro_break_minutes ? Number(settings.pomodoro_break_minutes) : 5,
        pomodoro_long_break_minutes: settings.pomodoro_long_break_minutes ? Number(settings.pomodoro_long_break_minutes) : 15,
        pomodoro_cycles: settings.pomodoro_cycles ? Number(settings.pomodoro_cycles) : 4,
        enable_sound: settings.enable_sound ?? true,
        notification_sound: settings.notification_sound || "default",
        pomodoro_sound: settings.pomodoro_sound || "pomodoro",
        enable_desktop_notifications: settings.enable_desktop_notifications ?? true,
        enable_task_notifications: settings.enable_task_notifications ?? true,
        task_notification_days: settings.task_notification_days ? Number(settings.task_notification_days) : 3,
        enable_spotify: settings.enable_spotify ?? true,
        spotify_playlist_url: settings.spotify_playlist_url || null,
        enable_flip_clock: settings.enable_flip_clock ?? true,
        flip_clock_size: settings.flip_clock_size || "medium",
