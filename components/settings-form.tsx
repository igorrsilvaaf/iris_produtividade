...
export function SettingsForm({ settings }: SettingsFormProps) {
  ...
  const { playlistId, setPlaylistId, setContentType, isEnabled, setIsEnabled } =
    useSpotifyStore();
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      enable_spotify:
        settings.enable_spotify !== undefined ? settings.enable_spotify : false,
      ...
      if (name === "enable_spotify") {
        if (value.enable_spotify === false) {
          ...
          try {
            ...
            console.error(
              "form.watch: Erro ao extrair dados da URL do Spotify:",
              error,
            );
          }
        }
    ...
    try {
      const processedValues = {
        ...
        task_notification_days:
          typeof values.task_notification_days === "string"
      ...
      if (
        settings.enable_spotify === true &&
        processedValues.enable_spotify === false
      ) {
        setPlaylistId(null);
                    ...
                    onClick={async () => {
                      try {
                        ...
                        if (generalValues.language !== language) {
                          ...
                          document.documentElement.lang =
                            generalValues.language === "en" ? "en" : "pt-BR";
                        }
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>
                            {t("Short Break Duration (minutes)")}
                          </FormLabel>
                          <FormControl>
                            <Input type="number" {...field} />
                          </FormControl>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            {t("chooseSound")} ({t("forPomodoroTimer")})
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                      ...
                      try {
                        ...
                        const pomodoroValues = {
                          pomodoro_work_minutes:
                            allValues.pomodoro_work_minutes,
                          pomodoro_break_minutes:
                            allValues.pomodoro_break_minutes,
                          pomodoro_long_break_minutes:
                            allValues.pomodoro_long_break_minutes,
                        ...
                        if (
                          form.getValues().enable_sound &&
                          form.getValues().pomodoro_sound !== "none"
                        ) {
                        ...
                        console.error(
                          "Erro ao salvar configurações do pomodoro:",
                          error,
                        );
                        toast({
                          variant: "destructive",
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            {t("chooseSound")} ({t("forGeneralNotifications")})
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div className="space-y-0.5">
                          ...
                          <FormDescription>
                            {t("showNotificationsForUpcomingTasks")}
                          </FormDescription>
                        </div>
                        <FormControl>
                          <Switch
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            {t("numberOfDaysBeforeToShowNotifications")}
                          </FormDescription>
                          <FormControl>
                            <Input
                              type="number"
                      ...
                      try {
                        ...
                        const notificationValues = {
                          ...
                          enable_desktop_notifications:
                            allValues.enable_desktop_notifications,
                          enable_task_notifications:
                            allValues.enable_task_notifications,
                          task_notification_days:
                            allValues.task_notification_days,
                        };
                        ...
                        // Verificar se deve tocar o som
                        if (
                          notificationValues.enable_sound &&
                          notificationValues.notification_sound !== "none"
                        ) {
            ...
            <TabsContent value="spotify">
              <Card className="overflow-hidden">
                <CardHeader className="px-4 sm:px-6">
                  ...
                  <CardDescription>
                    Configure sua playlist do Spotify ou Deezer para tocar
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div className="space-y-0.5">
                          <FormLabel className="text-base">
                            Ativar Player de Música
                          </FormLabel>
                          <FormDescription>
                            Exibir o player de música na interface para tocar
                            durante suas tarefas.
                          </FormDescription>
                        </div>
                        <FormControl>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            Cole o link da sua playlist do Spotify ou Deezer
                            para tocar durante suas tarefas.
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                  ...
                  <Button
                    ...
                    onClick={async () => {
                      try {
                        ...
                        // Processar a URL
                        if (
                          musicValues.spotify_playlist_url &&
                          musicValues.enable_spotify
                        ) {
                          try {
                            ...
                            console.error(
                              "Erro ao processar URL do player de música:",
                              err,
                            );
                          }
                        ...
                        toast({
                          ...
                          description:
                            "Suas configurações do player de música foram atualizadas com sucesso.",
                          variant: "success",
                          duration: 5000,
                        });
                        ...
                        console.error(
                          "Erro ao salvar configurações do player de música:",
                          error,
                        );
                        toast({
                          variant: "destructive",
            ...
            <TabsContent value="flipclock">
              <Card className="overflow-hidden">
                <CardHeader className="px-4 sm:px-6">
                  ...
                  <CardDescription>
                    Configure as preferências do seu relógio tipo Flip Clock.
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6 px-4 sm:px-6">
                  <FormField
                    ...
                    onClick={async () => {
                      try {
                        ...
                        toast({
                          title: "Configurações atualizadas",
                          description:
                            "Suas configurações do Flip Clock foram atualizadas com sucesso.",
                          variant: "success",
                          duration: 5000,
                        });
                        ...
                        console.error(
                          "Erro ao salvar configurações do Flip Clock:",
                          error,
                        );
                        toast({
                          variant: "destructive",
