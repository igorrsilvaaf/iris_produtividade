...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = getServerTranslation("inbox", lang as "en" | "pt");
...
export default async function InboxPage() {
  ...
  console.log("--- Inbox Page Server Component ---");
  ...
  console.log("[inbox.tsx] Idioma do cookie:", initialLanguage);
  
  // Obter a tradução diretamente usando getServerTranslation
  const translatedTitle = getServerTranslation("inbox", initialLanguage as "en" | "pt");
  console.log("[inbox.tsx] Título traduzido:", translatedTitle);
