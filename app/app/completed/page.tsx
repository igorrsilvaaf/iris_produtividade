...
export default async function CompletedPage() {
  ...
  console.log("[completed.tsx] Idioma do cookie:", initialLanguage);
  
  // Obter a tradução diretamente usando getServerTranslation
  const translatedTitle = getServerTranslation("completed", initialLanguage as "en" | "pt");
  console.log("[completed.tsx] Título traduzido:", translatedTitle);
